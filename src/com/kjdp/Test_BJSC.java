...
public class Test_BJSC {
	/**
	 * 北京赛车-两面 中奖分析
	 * @param json
	 * @return
	 */
	public static double  BJSC_LM_cal(String json,int[] nums)	
	{
	 int kaijian[]=nums;
	 double sum=0;
	 ...
	 * @return
	 */
	public static double  BJSC_GY_cal(String json,int[] nums){
		 int kaijian[]=nums;
		double sum=0;
		  JSONObject topJson = JSONObject.fromObject(json); 
		  String category =topJson.get("category").toString();
	 ...
	 * @return 中奖结果
	 */
	public static double  BJSC_DH_cal(String json,int[] nums){
		int kaijiang[]=nums;
		double sum=0;
