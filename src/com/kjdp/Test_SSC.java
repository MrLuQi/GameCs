 ...
 * @return 中奖金额
 */
	public static double SSC_LM_cal(String json,int[] args){
		//开奖号码
		 int kaijiang[]=args;
		 //开奖号码总和
	 ...
	 * @return 中奖金额
	 */
		public static double SSC_DYIQ_cal(String json,int[] args){
			//开奖号码
			int kaijiang[]=args;
			//开奖号码总和
			 int nums=kaijiang[0]+kaijiang[1]+kaijiang[2]+kaijiang[3]+kaijiang[4];
	 ...
	 * @return 中奖金额
	 */
		public static double SSC_DERQ_cal(String json,int[] args){
			//开奖号码
			int kaijiang[]=args;
			//开奖号码总和
			 int nums=kaijiang[0]+kaijiang[1]+kaijiang[2]+kaijiang[3]+kaijiang[4];
		 ...
		 * @return 中奖金额
		 */
			public static double SSC_DSANQ_cal(String json,int[] args){
				//开奖号码
				int kaijiang[]=args;
				//开奖号码总和
				 int nums=kaijiang[0]+kaijiang[1]+kaijiang[2]+kaijiang[3]+kaijiang[4];
			 ...
			 * @return 中奖金额
			 */
				public static double SSC_DSIQ_cal(String json,int[] args){
					//开奖号码
					int kaijiang[]=args;
					//开奖号码总和
					 int nums=kaijiang[0]+kaijiang[1]+kaijiang[2]+kaijiang[3]+kaijiang[4];
				 ...
				 * @return 中奖金额
				 */
					public static double SSC_DWUQ_cal(String json,int[] args){
						//开奖号码
						int kaijiang[]=args;
						//开奖号码总和
						 int nums=kaijiang[0]+kaijiang[1]+kaijiang[2]+kaijiang[3]+kaijiang[4];
...
public static void main(String[] args) {
	...
	//测试两面玩法，并且计算中奖金额
	//JsonBoCai  lm =SSC_LM();
    //JSONObject json_lm = JSONObject.fromObject(lm);
   // String str_json_lm=json_lm.toString();
   // System.out.println(json_lm);
   // System.out.println(str_json_lm);
   //int  totalHit_lm=(int)SSC_LM_cal(str_json_lm);
   // System.out.println("中奖金额:"+totalHit_lm);
}
}
